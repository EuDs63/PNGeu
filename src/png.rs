...
impl Png {
    ...
    pub fn remove_chunk(&mut self, chunk_type: &str) -> Result<Chunk> {
        // let want_chunk_type = ChunkType::from_str(chunk_type).unwrap();
        // for (i,c) in &mut self.chunks.iter().enumerate(){
        //     if c.chunk_type() == &want_chunk_type{
        ...
        self.chunks
            ...
            .ok_or_else(|| "non existed chunk".into())
    }
    ...
    pub fn chunk_by_type(&self, chunk_type: &str) -> Option<&Chunk> {
        ...
        //     .iter()
        //     .position(|chunk|chunk.chunk_type().to_string().as_str() == chunk_type)
        //     .map(|index|return Some(&self.chunks[index]));
        // return None;
        self.chunks
            .iter()
    ...
    pub fn as_bytes(&self) -> Vec<u8> {
        // let mut result = self.header.iter();
        // self.chunks
        //     .iter()
        //     .map(|chunk| result.chain(chunk.as_bytes().iter()))
        //     .copied()
        //     .collect()
